...
# Project FRC Sri Lanka - Brand & Design Guide

## 1. Color Palette
Lean into the red (Cinnabar) to create an energetic, urgent, and professional look. 
- **Primary Accent (Cinnabar):** `#ab312d` (Use for major call-to-actions, borders, icons)
- **Background (Carbon):** `#141414`
